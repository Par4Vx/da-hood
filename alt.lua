...
loadstring(game:HttpGet("https://raw.githubusercontent.com/Par4Vx/da-hood/main/ripanticheat.lua"))()
...
if getgenv().AutoRender == true then
	...
	TextLabel.Text = "cool , Welcome "..game.Players.LocalPlayer.Name.." yes that is ur username if u wanna see it monkey"
			...
			if game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") and game.Players.LocalPlayer.Character.Humanoid.Health > 0 then
				if Player.Character and Player.Character:FindFirstChild("HumanoidRootPart")  and Player.Character:FindFirstChild("Humanoid") and Player.Character.Humanoid.Health > 0 then
					...
					elseif Chat == ".shuffle" then
						...
						CurrAnim:Play()
						CurrAnim:AdjustSpeed()
                    elseif Chat == ".toprock" then
                        if CurrAnim and CurrAnim.IsPlaying then
                                CurrAnim:Stop()
                        end
                        local Anim = Instance.new("Animation")
                        Anim.AnimationId = "http://www.roblox.com/asset/?id=3361276673"
                        CurrAnim = game.Players.LocalPlayer.Character.Humanoid.Animator:LoadAnimation(Anim)
                        CurrAnim:Play()
                        CurrAnim:AdjustSpeed()
					elseif Chat == ".panini" then
						if CurrAnim and CurrAnim.IsPlaying then
							CurrAnim:Stop()
						end
						local Anim = Instance.new("Animation")
						Anim.AnimationId = "http://www.roblox.com/asset/?id=5915713518"
						CurrAnim = game.Players.LocalPlayer.Character.Humanoid.Animator:LoadAnimation(Anim)
						CurrAnim:Play()
						CurrAnim:AdjustSpeed()
